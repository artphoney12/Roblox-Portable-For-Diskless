...
def show_notification():
    ...
    print("==================================================")
    print("Silakan melakukan donasi minimal 50rb rupiah atau lebih untuk menghilangkan notifikasi dan mensupport pembuat portable ini...")
    print("[INFO] Pembayaran Via QRIS.")
    print("==================================================")
